...
import { 
  FileText, Download, Calendar, User, Target, Award, 
  Phone, PhoneForwarded, Users, Clock, RefreshCw, Loader2,
...
const DailyTrackingSheet = () => {
  ...
  const downloadPDF = (userData) => {
    ...
    doc.text(`MONTH: ${userData.month}`, 120, headerY);
    doc.text(`FILE GOAL: ${userData.file_goal}`, 14, headerY + 7);
    doc.text(`ACHIEVED: ${userData.achieved_files}`, 120, headerY + 7);
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      {isLoading ? (
        ...
        <div className="card overflow-hidden">
          {/* Sheet Header - Matching the image */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-3 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-blue-600">{currentUserData.file_goal}</span>
                </div>
              </div>
              <div className="bg-white rounded-lg p-3 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-lg font-bold ${currentUserData.achieved_files >= currentUserData.file_goal ? 'text-green-600' : 'text-orange-500'}`}>
                    {currentUserData.achieved_files}
                  </span>
                </div>
              </div>
            </div>
