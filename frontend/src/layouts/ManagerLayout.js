...
import { LayoutDashboard, FileText, FolderOpen, BarChart3, LogOut, ClipboardList, Clock, Calendar, MoreHorizontal, Users, Database, PhoneCall } from 'lucide-react';
...
const ManagerLayout = () => {
  ...
  // Primary nav items - 5 items max for mobile (similar to Admin but no Users/Approvals)
  const primaryNavItems = [
    { path: '/manager', icon: LayoutDashboard, label: 'Dashboard', exact: true },
    { path: '/manager/leads', icon: FileText, label: 'Data' },
    { path: '/manager/files', icon: FolderOpen, label: 'Files' },
    { path: '/manager/tracking', icon: ClipboardList, label: 'Follow-ups' },
  ];

  // More menu items - Reports, Attendance, Leave + Team pages
  const moreNavItems = [
  ...
  // Team pages for Manager view
  const teamNavItems = [
    { path: '/manager/team', icon: Users, label: 'My Team' },
    { path: '/manager/team/data', icon: Database, label: 'Team Data' },
    { path: '/manager/team/files', icon: FileText, label: 'Team Files' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Bottom Navigation - 5 items: Dashboard, Data, Files, Follow-ups, More */}
