...
from routes.admin_migration import router as admin_migration_router  # TEMPORARY - remove after prod migration
...
app.include_router(admin_migration_router)  # TEMPORARY - remove after prod migration
